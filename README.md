...
Here, I introduced how to create and use databases using sql syntax. In addition, you will be able to learn how to `CRUD`ing data. `CRUD` means `Create`, `Read`, `Update`, and `Delete`! So, after finishing this part, you will be able to create and manipulate databases, tables, and data in tables.
